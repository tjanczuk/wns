...
var createAudio = function (type, options) {
	...
	if (typeof options.audio.src === 'string') {
		...
		}) && !options.audio.src.indexOf("ms-appx") === 0 && !options.audio.src.indexOf("ms-appdata") === 0)
	...
	if (options.audio.src)
		result += ' src="' 
				+ ((options.audio.src.indexOf(audioSourcePrefix) === 0 || 
					options.audio.src.indexOf("ms-appx") === 0 || 
					options.audio.src.indexOf("ms-appdata") === 0) ? options.audio.src : audioSourcePrefix + options.audio.src) 
				+ '"';
